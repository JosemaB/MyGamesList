...
try {
    ...
    $resenasQuery = "SELECT u.nombre_usuario, u.avatar, r.id_resena, r.img_juego, r.contenido, r.id_videojuego_api, r.fecha_publicacion FROM usuarios u, resenas r WHERE u.id_usuario = r.id_usuario";
